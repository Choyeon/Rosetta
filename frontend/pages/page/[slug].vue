...
const KNOWN_TOP_LEVEL: string[] = [
  'about', 'guestbook', 'gallery', 'archive', 'friends', 'activity',
  'login', 'register', 'oobe', 'posts', 'categories', 'tags', 'series'
]
...
const renderedContent = computed(() => {
  ...
  try {
    ...
    console.warn('[compat/page/slug] markdown render failed', e)
    return ''
  }
})
...
useBreadcrumbJsonLd([
  ...
  { name: title.value || slug.value, url: `/page/${slug.value}` }
])
</script>
